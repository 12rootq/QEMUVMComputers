...
public class ItemPreviewRender extends EntityRenderer<EntityItemPreview>{
	public ItemPreviewRender(EntityRendererFactory.Context context) {
		super(context);
	}
	...
	public void render(EntityItemPreview entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		MinecraftClient.getInstance().getItemRenderer().renderItem(entity.getPreviewedItemStack(), ModelTransformationMode.NONE, 200, 0, matrices, vertexConsumers, entity.getWorld(), 0);
		matrices.pop();
		matrices.pop();
	}
}
