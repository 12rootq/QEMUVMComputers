...
public class MouseRender extends EntityRenderer<EntityMouse>{
	public MouseRender(EntityRendererFactory.Context context) {
		super(context);
	}
	...
	public void render(EntityMouse entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		MinecraftClient.getInstance().getItemRenderer().renderItem(new ItemStack(ItemList.ITEM_MOUSE), ModelTransformationMode.NONE, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, entity.getWorld(), 0);
		matrices.pop();
	}
