...
public class SetupPageUnfocusBinding extends SetupPage{
	...
	public void init() {
		if(changeBinding) {
			setupGui.addButton(ButtonWidget.builder(Text.literal((bindingToBeChangedNum == 1 ? "> " : "") + getKeyName(glfwUnfocusKey1) + (bindingToBeChangedNum == 1 ? " <" : "")), (bw) -> changeBinding(1)).dimensions(setupGui.width/2-130, setupGui.height/2-10, 60, 20).build());
			setupGui.addButton(ButtonWidget.builder(Text.literal((bindingToBeChangedNum == 2 ? "> " : "") + getKeyName(glfwUnfocusKey2) + (bindingToBeChangedNum == 2 ? " <" : "")), (bw) -> changeBinding(2)).dimensions(setupGui.width/2-64, setupGui.height/2-10, 60, 20).build());
			setupGui.addButton(ButtonWidget.builder(Text.literal((bindingToBeChangedNum == 3 ? "> " : "") + getKeyName(glfwUnfocusKey3) + (bindingToBeChangedNum == 3 ? " <" : "")), (bw) -> changeBinding(3)).dimensions(setupGui.width/2+3, setupGui.height/2-10, 60, 20).build());
			setupGui.addButton(ButtonWidget.builder(Text.literal((bindingToBeChangedNum == 4 ? "> " : "") + getKeyName(glfwUnfocusKey4) + (bindingToBeChangedNum == 4 ? " <" : "")), (bw) -> changeBinding(4)).dimensions(setupGui.width/2+70, setupGui.height/2-10, 60, 20).build());
		}else {
			setupGui.addButton(ButtonWidget.builder(Text.literal(getKeyName(glfwUnfocusKey1)), (bw) -> changeBinding(1)).dimensions(setupGui.width/2-130, setupGui.height/2-10, 60, 20).build());
			setupGui.addButton(ButtonWidget.builder(Text.literal(getKeyName(glfwUnfocusKey2)), (bw) -> changeBinding(2)).dimensions(setupGui.width/2-64, setupGui.height/2-10, 60, 20).build());
