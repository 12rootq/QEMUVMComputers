...
public class ItemPCCaseSidepanel extends OrderableItem {
    public ItemPCCaseSidepanel(Properties properties) {
        super(properties, 6);
    }
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ItemPCCase.appendPcTooltip(stack, tooltip);
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable("item.newvmcomputers.pc_case_sidepanel");
    }

    public static ItemStack createPCStackByEntity(EntityPC pc) {
        ItemStack stack = new ItemStack(ItemList.PC_CASE_SIDEPANEL.get());
